...
const rankImages = {
  Platinum:
    'https://res.cloudinary.com/dhrugparh/image/upload/v1748429537/Platinum_ydzy5q.png',
  Gold: 'https://res.cloudinary.com/dhrugparh/image/upload/v1748429529/Gold_kaeyoj.png',
  Silver:
    'https://res.cloudinary.com/dhrugparh/image/upload/v1748429516/Silver_kvsxel.png',
  Bronze:
    'https://res.cloudinary.com/dhrugparh/image/upload/v1748429525/Bronze_ztc6rv.png',
};
    ...
    const fetchProfile = async () => {
      ...
      try {
        const response = await fetch(
          `http://localhost:5000/user-routes/profile/${userId}`,
          {
            headers: {
  ...
  return (
    <div className="evaluation-card">
      <div className="evaluation-info">
        <div
          className="attendance-rate-container fade-in-up"
          style={{ animationDelay: '0.1s' }}
        >
          <div className="attendance-label">
            <strong>Attendance Rate:</strong>{' '}
            {(profile.attendance_rate * 100).toFixed(0)}%
          </div>
        ...
        <div
          className="points-circle-container fade-in-up"
         ...
         a 15.9155 15.9155 0 0 1 0 -31.831"
            ...
            <path
              ...
              strokeDasharray={`${Math.min(
                (profile.total_points / 10000) * 100,
                100
              )}, 100`}
              d="M18 2.0845
         a 15.9155 15.9155 0 0 1 0 31.831
        ...
        <div
          className="rank-section fade-in-up"
