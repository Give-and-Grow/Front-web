...
export default function JobOpportunities() {
  ...
  //const [mainFilter, setMainFilter] = useState("Jobs");
...
const [filter, setFilter] = useState('Jobs');
  useEffect(() => {
    async function fetchOpportunities() {
      try {
        ...
        const response = await fetch(`http://localhost:5000/recommendations/opportunities?type=job`, {
          headers,
        });
  ...
  return (
    ...
    <OpportunityFilters onFilterSelect={handleFilterChange} initialFilter="Jobs" />
